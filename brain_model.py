...
from imageai.Classification import ImageClassification # The lib make prediction in classification object

import os # This brings in imgs that needs to be predicted 
